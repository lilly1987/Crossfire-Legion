    ...
    public class Sample : BaseUnityPlugin
    {
        ...
        public virtual void WindowFunction(int id)
        {
            ...
            else // 열렸을때
            {
                ...
                //if (GUILayout.Button("set money") { isGUIOn.Value = false; }
        ...
        [HarmonyPostfix]
        public static void XPPickerCtor(Inventory __instance)
        {
            logger.LogMessage($"{__instance.Attributes.ToString()}");
        }

        //[HarmonyPatch(typeof(Inventory), MethodType.)]
        //[HarmonyPostfix]
        //public static void XPPickerCtor(Inventory __instance)
        //{
        //    logger.LogMessage($"{__instance.Attributes.ToString()}");
